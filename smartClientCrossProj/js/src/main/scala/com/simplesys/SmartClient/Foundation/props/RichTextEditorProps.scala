...
class RichTextEditorProps extends VLayoutProps {
    ...
    var bulletControls: ScOption[js.Array[ControlName]] = ScNone
    var colorControls: ScOption[js.Array[ControlName]] = ScNone
    var colorPrompt: ScOption[String] = ScNone
    var controlGroups: ScOption[js.Array[ControlName]] = ScNone
    ...
    var fontControls: ScOption[js.Array[ControlName]] = ScNone
    ...
    var formatControls: ScOption[js.Array[ControlName]] = ScNone
