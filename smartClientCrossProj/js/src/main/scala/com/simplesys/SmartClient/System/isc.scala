...
object iscStatic extends Types.Object {
    ...
    def getKeyForValue(value: Int, valueMap: js.Dictionary[Types.Object], defaultKey: JSAny): JSAny = js.native
    def getKeys(obj: Types.Object): js.Array[String] = js.native
    def getValueForKey(value: Int, valueMap: js.Dictionary[Types.Object], defaultKey: JSAny): JSAny = js.native
