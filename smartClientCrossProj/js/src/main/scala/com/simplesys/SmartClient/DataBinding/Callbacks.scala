...
@js.native
trait DSCallback extends js.Function3[DSResponse,js.Dictionary[JSAny], DSRequest, void]

@js.native
trait RPCCallback extends js.Function3[RPCResponse,js.Dictionary[JSAny], RPCRequest, void]
