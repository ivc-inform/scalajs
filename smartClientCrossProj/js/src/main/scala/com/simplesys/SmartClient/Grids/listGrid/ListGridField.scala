...
trait ListGridField extends Types.Object {
    ...
    def formatCellValue(value: js.Any, record: ListGridRecord, rowNum: Int, colNum: Int, grid: ListGrid[ListGridField]): HTMLString
    def formatEditorValue(value: js.Any, record: ListGridRecord, rowNum: Int, colNum: Int, grid: ListGrid[ListGridField]): js.Any
    var formatGridSummary: String
    var formatGroupSummary: String
    var frozen: Boolean
    def getAutoFreezePosition(): Int
    def getEditorValueMap(values: Types.Object, field: ListGridField, grid: ListGrid[ListGridField]): ValueMap
    def getFieldTitle(viewer: ListGrid[ListGridField], fieldNum: Int): String
    ...
    var hoverDelay: Int
    var hoverHTML: js.Function5[ListGridRecord, js.Any, Int, Int, ListGrid[ListGridField], HTMLString]
    var hoverWidth: Int
    ...
    def parseEditorValue(value: js.Any, record: Types.Object, rowNum: Int, colNum: Int, grid: ListGrid[ListGridField]): js.Any
    var partialSummary: Boolean
    var prompt: HTMLString
    var recordClick: js.Function7[ListGrid[ListGridField], ListGridRecord, Int, ListGridField, Int, js.Any, js.Any, Boolean]
    var recordDoubleClick: js.Function7[ListGrid[ListGridField], ListGridRecord, Int, ListGridField, Int, js.Any, js.Any, Boolean]
    ...
    var showIf: js.Function3[ListGrid[ListGridField], ListGridField, Int, Boolean]
    ...
    def sortNormalizer(recordObject: Types.Object, fieldName: String, context: ListGrid[ListGridField]): js.Any
    ...
    var valueIconClick: js.Function6[ListGrid[ListGridField], ListGridRecord, Int, ListGridField, js.Any, FormItem, Boolean]
