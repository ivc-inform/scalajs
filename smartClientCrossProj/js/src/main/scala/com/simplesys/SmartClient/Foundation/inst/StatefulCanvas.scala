...
import com.simplesys.isc.System.Types.SelectionType._
...
trait StatefulCanvas extends Canvas {
    var actionType: SelectionType
        def addToRadioGroup(groupID: String): Unit
        var align: Alignment
        var autoFit: Boolean
        var baseStyle: CSSStyleName
        def deselect(): Unit
        def getActionType(): Unit
        def getState(): State
        ...
        def removeFromRadioGroup(groupID: String = js.native): Unit
        def select(): Unit
        val selected: Boolean
        def setActionType(): Unit
        def setAutoFit(autoFit: Boolean): Unit
        def setBaseStyle(style: CSSStyleName): Unit
        def setIcon(icon: URL): Unit
        def setIconOrientation(orientation: String): Unit
        def setIconStyle(iconStyle: CSSStyleName): Unit
        def setIgnoreRTL(ignoreRTL: Boolean): Unit
        def setSelected(newIsSelected: Boolean): Unit
