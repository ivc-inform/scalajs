...
class CanvasProps extends ClassProps {
    ...
    var click: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    ...
    var doubleClick: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    ...
    var dragMove: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    ...
    var dragRepositionMove: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dragRepositionStart: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dragRepositionStop: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dragResizeAppearance: ScOption[DragAppearance] = ScNone
    var dragResizeMove: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dragResizeStart: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dragResizeStop: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dragScrollDelay: ScOption[Int] = ScNone
    var dragStart: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dragStartDistance: ScOption[Int] = ScNone
    var dragStop: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dragTarget: ScOption[Canvas] = ScNone
    var dragType: ScOption[String] = ScNone
    var drop: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dropMove: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dropOut: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var dropOver: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    ...
    var hover: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    ...
    var keyDown: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var keyPress: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var keyUp: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    ...
    var mouseDown: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var mouseMove: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var mouseOut: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var mouseOver: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var mouseStillDown: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    ...
    var resized: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var resizeFrom: ScOption[Seq[EdgeName]] = ScNone
    var rightMouseDown: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var scrollbarConstructor: ScOption[String] = ScNone
    var scrollbarSize: ScOption[Int] = ScNone
    var scrolled: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    var setDragTracker: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
    ...
    var showContextMenu: ScOption[js.ThisFunction0[canvasHandler, Boolean]] = ScNone
