...
class CanvasProps extends ClassProps {
    ...
    val children: ScOption[Seq[Canvas]] = ScNone
    ...
    val dropTypes: ScOption[Seq[String]] = ScNone
    ...
    val peers: ScOption[Seq[Canvas]] = ScNone
    ...
    val proportionalResizeModifiers: ScOption[Seq[KeyName]] = ScNone
    ...
    val resizeFrom: ScOption[Seq[EdgeName]] = ScNone
    ...
    val snapAlignCandidates: ScOption[Seq[Canvas]] = ScNone
