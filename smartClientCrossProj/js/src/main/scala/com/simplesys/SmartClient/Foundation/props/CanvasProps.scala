...
class CanvasProps extends ClassProps {
    ...
    var edgeOffset: ScOption[Number] = ScNone
    var edgeOpacity: ScOption[Number] = ScNone
    var edgeShowCenter: ScOption[Boolean] = ScNone
    var edgeSize: ScOption[Number] = ScNone
    ...
    var height: ScOption[Number] = ScNone
    ...
    var left: ScOption[Number] = ScNone
    ...
    var margin: ScOption[Number] = ScNone
    ...
    var opacity: ScOption[Number] = ScNone
    var overflow: ScOption[Overflow] = ScNone
    var padding: ScOption[Number] = ScNone
    ...
    var scrollbarSize: ScOption[Number] = ScNone
    ...
    var shadowDepth: ScOption[Number] = ScNone
    var shadowImage: ScOption[Number] = ScNone
    ...
    var top: ScOption[Number] = ScNone
    ...
    var width: ScOption[Number] = ScNone
}
