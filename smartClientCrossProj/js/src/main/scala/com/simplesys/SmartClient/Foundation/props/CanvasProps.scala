...
class CanvasProps extends ClassProps {
    ...
    var click: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    ...
    var doubleClick: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    ...
    var dragMove: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    ...
    var dragRepositionMove: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dragRepositionStart: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dragRepositionStop: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dragResizeAppearance: ScOption[DragAppearance] = ScNone
    var dragResizeMove: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dragResizeStart: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dragResizeStop: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dragScrollDelay: ScOption[Int] = ScNone
    var dragStart: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dragStartDistance: ScOption[Int] = ScNone
    var dragStop: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dragTarget: ScOption[Canvas] = ScNone
    var dragType: ScOption[String] = ScNone
    var drop: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dropMove: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dropOut: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var dropOver: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    ...
    var hover: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    ...
    var keyDown: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var keyPress: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var keyUp: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    ...
    var mouseDown: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var mouseMove: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var mouseOut: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var mouseOver: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var mouseStillDown: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var mouseStillDownDelay: ScOption[Int] = ScNone
    var mouseStillDownInitialDelay: ScOption[Int] = ScNone
    var mouseUp: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var mouseWheel: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    ...
    var resized: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var resizeFrom: ScOption[Seq[EdgeName]] = ScNone
    var rightMouseDown: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var scrollbarConstructor: ScOption[String] = ScNone
    var scrollbarSize: ScOption[Int] = ScNone
    var scrolled: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    var setDragTracker: ScOption[Function1[canvasHandler, Boolean]] = ScNone
    ...
    var showContextMenu: ScOption[Function1[canvasHandler, Boolean]] = ScNone
