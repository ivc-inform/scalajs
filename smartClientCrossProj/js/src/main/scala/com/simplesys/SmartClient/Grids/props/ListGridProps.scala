...
class ListGridProps extends VLayoutProps with DataBoundComponentProps {
    ...
    var autoFitClipFields: ScOption[js.Array[String]] = ScNone
    ...
    var bodyKeyPress: ScOption[js.ThisFunction0[callbackHandler, Boolean]] = ScNone
    ...
    var cellChanged: ScOption[js.Function5[ListGridRecord, js.Any, Int, Int, ListGrid[ListGridField, ListGridRecord], void]] = ScNone
    ...
    var cellErrorIconHover: ScOption[js.Function3[ListGridRecord, Int, Int, Boolean]] = ScNone
    ...
    var checkboxField: ScOption[ListGridField ] = ScNone
    ...
    var defaultFields: ScOption[js.Array[ListGridField]] = ScNone
    ...
    var drawAreaChanged: ScOption[js.ThisFunction4[callbackHandler, Int, Int, Int, Int, void]] = ScNone
    var editByCell: ScOption[Boolean] = ScNone
    var editComplete: ScOption[js.ThisFunction6[callbackHandler, Int, Int, Record, Record, EditCompletionEvent, DSResponse, void]] = ScNone
    var editEvent: ScOption[ListGridEditEvent] = ScNone
    var editFailed: ScOption[js.ThisFunction6[callbackHandler, Int, Int, Record, Record, EditCompletionEvent, DSResponse, void]] = ScNone
    ...
    var editorEnter: ScOption[js.ThisFunction4[callbackHandler, ListGridRecord, js.Any, Int, Int, void]] = ScNone
    var editorExit: ScOption[js.ThisFunction5[callbackHandler, EditCompletionEvent, ListGridRecord, js.Any, Int, Int, Boolean]] = ScNone
    ...
    var expansionField: ScOption[ListGrid[ListGridField, ListGridRecord] ] = ScNone
    ...
    var expansionRelated: ScOption[ListGrid[ListGridField, ListGridRecord] with MultiAutoChild] = ScNone
    ...
    var fieldPickerFieldProperties: ScOption[js.Array[String]] = ScNone
    var fieldPickerShowSampleValues: ScOption[String] = ScNone
    var fields: ScOption[js.Array[ListGridField]] = ScNone
    ...
    var formatCellValue: ScOption[js.ThisFunction3[callbackHandler, ListGridRecord, Int, Int, HTMLString]] = ScNone
    var formatEditorValue: ScOption[js.ThisFunction3[callbackHandler, ListGridRecord, Int, Int, js.Any]] = ScNone
    ...
    var getBaseStyle: ScOption[js.ThisFunction3[callbackHandler, ListGridRecord, Int, Int, CSSStyleName]] = ScNone
    var getCellHoverComponent: ScOption[js.ThisFunction3[callbackHandler, ListGridRecord, Int, Int, Canvas]] = ScNone
    var getCellRecord: ScOption[js.ThisFunction1[callbackHandler, Int, ListGridRecord]] = ScNone
    var getCellStyle: ScOption[js.ThisFunction3[callbackHandler, ListGridRecord, Int, Int, CSSStyleName]] = ScNone
    var getCellValue: ScOption[js.ThisFunction3[callbackHandler, ListGridRecord, Int, Int, String]] = ScNone
    var getDragData: ScOption[js.Function1[DataBoundComponent, js.Array[ListGridRecord]]] = ScNone
    ...
    var groupTitleColumnDefaults: ScOption[ListGridField] = ScNone
    var groupTitleColumnProperties: ScOption[ListGridField] = ScNone
    ...
    var headerSpans: ScOption[js.Array[HeaderSpan]] = ScNone
    ...
    var hilitesChanged: ScOption[js.ThisFunction0[callbackHandler, void]] = ScNone
    ...
    var initialSort: ScOption[js.Array[SortSpecifier]] = ScNone
    ...
    var parseEditorValue: ScOption[js.Function4[js.Any, ListGridRecord, Int, Int, js.Any]] = ScNone
    ...
    var recordClick: ScOption[js.ThisFunction7[callbackHandler, ListGrid[ListGridField, ListGridRecord], ListGridRecord, Int, ListGridField, Int, js.Any, js.Any, Boolean]] = ScNone
    ...
    var recordDoubleClick: ScOption[js.ThisFunction7[callbackHandler, ListGrid[ListGridField, ListGridRecord], ListGridRecord, Int, ListGridField, Int, js.Any, js.Any, Boolean]] = ScNone
    ...
    var removeFieldDefaults: ScOption[ListGridField] = ScNone
    var removeFieldProperties: ScOption[ListGridField] = ScNone
    var removeFieldTitle: ScOption[String] = ScNone
    var removeIcon: ScOption[SCImgURL] = ScNone
    var removeIconSize: ScOption[Int] = ScNone
    var removeRecordClick: ScOption[js.ThisFunction1[callbackHandler, Int, void]] = ScNone
    ...
    var rowClick: ScOption[js.Function4[ListGridRecord, Int, Int, Boolean, Boolean]] = ScNone
    var rowContextClick: ScOption[js.Function3[ListGridRecord, Int, Int, Boolean]] = ScNone
    var rowDoubleClick: ScOption[js.Function4[ListGridRecord, Int, Int, Boolean, Boolean]] = ScNone
    var rowEditorEnter: ScOption[js.Function3[ListGridRecord, Types.Object, Int, void]] = ScNone
    var rowEditorExit: ScOption[js.Function4[EditCompletionEvent, ListGridRecord, Types.Object, Int, Boolean]] = ScNone
    ...
    var rowNumberField: ScOption[ListGridField ] = ScNone
    ...
    var selectionChanged: ScOption[js.Function2[ListGridRecord, Boolean, void]] = ScNone
    ...
    var selectionUpdated: ScOption[js.Function2[ListGridRecord, js.Array[ListGridRecord], void]] = ScNone
    ...
    var showRecordComponent: ScOption[js.Function2[ListGridRecord, Int, Boolean]] = ScNone
    ...
    var summaryRow: ScOption[ListGrid[ListGridField, ListGridRecord] ] = ScNone
    ...
    var summaryUpdated: ScOption[js.ThisFunction2[callbackHandler, ListGridField, UserSummary, void]] = ScNone
    ...
    var updateRecordComponent: ScOption[js.Function4[ListGridRecord, Int, Canvas, Boolean, Canvas]] = ScNone
    ...
    var viewStateChanged: ScOption[js.ThisFunction0[callbackHandler, void]] = ScNone
