...
object DoubleType {
    implicit def Int2IntString(x: Int):ScOption[IntString[Int, String]] = ScSome(IntFRomIntString(x))
    implicit def Stringt2IntString(x: String):ScOption[IntString[Int, String]] = ScSome(StringFRomIntString(x))
}
//</editor-fold>
