...
package com.simplesys.underscore {
    ...
    trait UnderscoreStatic extends js.Object {
        ...
        def each[T](list: List[T], iterator: /*__.*/ListIterator[T, Unit], context: js.Any = ???): List[T] = js.native
        @JSName("each")
        def eachDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Unit], context: js.Any = ???): Dictionary[T] = js.native
        def forEach[T](list: List[T], iterator: /*__.*/ListIterator[T, Unit], context: js.Any = ???): List[T] = js.native
        @JSName("forEach")
        def forEachDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Unit], context: js.Any = ???): Dictionary[T] = js.native
        def map[T, TResult](list: List[T], iterator: /*__.*/ListIterator[T, TResult], context: js.Any = ???): js.Array[TResult] = js.native
        @JSName("map")
        def mapDictionary[T, TResult](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, TResult], context: js.Any = ???): js.Array[TResult] = js.native
        def collect[T, TResult](list: List[T], iterator: /*__.*/ListIterator[T, TResult], context: js.Any = ???): js.Array[TResult] = js.native
        @JSName("collect")
        def collectDictionary[T, TResult](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, TResult], context: js.Any = ???): js.Array[TResult] = js.native
        def reduce[T, TResult](list: Collection[T], iterator: /*__.*/MemoIterator[T, TResult], memo: TResult = ???, context: js.Any = ???): TResult = js.native
        def inject[T, TResult](list: Collection[T], iterator: /*__.*/MemoIterator[T, TResult], memo: TResult = ???, context: js.Any = ???): TResult = js.native
        def foldl[T, TResult](list: Collection[T], iterator: /*__.*/MemoIterator[T, TResult], memo: TResult = ???, context: js.Any = ???): TResult = js.native
        def reduceRight[T, TResult](list: Collection[T], iterator: /*__.*/MemoIterator[T, TResult], memo: TResult = ???, context: js.Any = ???): TResult = js.native
        def foldr[T, TResult](list: Collection[T], iterator: /*__.*/MemoIterator[T, TResult], memo: TResult = ???, context: js.Any = ???): TResult = js.native
        def find[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean], context: js.Any = ???): T = js.native
        @JSName("find")
        def findDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Boolean], context: js.Any = ???): T = js.native
        def detect[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean], context: js.Any = ???): T = js.native
        @JSName("detect")
        def detectDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Boolean], context: js.Any = ???): T = js.native
        def findIndex[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean], context: js.Any = ???): Double = js.native
        def filter[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean], context: js.Any = ???): js.Array[T] = js.native
        @JSName("filter")
        def filterDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Boolean], context: js.Any = ???): js.Array[T] = js.native
        def select[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean], context: js.Any = ???): js.Array[T] = js.native
        @JSName("select")
        def selectDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Boolean], context: js.Any = ???): js.Array[T] = js.native
        ...
        def reject[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean], context: js.Any = ???): js.Array[T] = js.native
        @JSName("reject")
        def rejectDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Boolean], context: js.Any = ???): js.Array[T] = js.native
        def every[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean] = ???, context: js.Any = ???): Boolean = js.native
        def all[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean] = ???, context: js.Any = ???): Boolean = js.native
        def some[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean] = ???, context: js.Any = ???): Boolean = js.native
        @JSName("some")
        def someDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Boolean] = ???, context: js.Any = ???): Boolean = js.native
        def any[T](list: List[T], iterator: /*__.*/ListIterator[T, Boolean] = ???, context: js.Any = ???): Boolean = js.native
        @JSName("any")
        def anyDictionary[T](`object`: Dictionary[T], iterator: /*__.*/ObjectIterator[T, Boolean] = ???, context: js.Any = ???): Boolean = js.native
        ...
        def max[T](list: List[T], iterator: /*__.*/ListIterator[T, js.Any] = ???, context: js.Any = ???): T = js.native
        def min(list: List[Double]): Double = js.native
        def min[T](list: List[T], iterator: /*__.*/ListIterator[T, js.Any] = ???, context: js.Any = ???): T = js.native
        def sortBy[T, TSort](list: List[T], iterator: /*__.*/ListIterator[T, TSort] = ???, context: js.Any = ???): js.Array[T] = js.native
        @JSName("sortBy")
        def sortByString[T](list: List[T], iterator: String, context: js.Any = ???): js.Array[T] = js.native
        def groupBy[T](list: List[T], iterator: /*__.*/ListIterator[T, js.Any] = ???, context: js.Any = ???): Dictionary[js.Array[T]] = js.native
        def indexBy[T](list: List[T], iterator: /*__.*/ListIterator[T, js.Any], context: js.Any = ???): Dictionary[T] = js.native
        def countBy[T](list: List[T], iterator: /*__.*/ListIterator[T, js.Any] = ???, context: js.Any = ???): Dictionary[Double] = js.native
        ...
        def flatten(array: List[js.Any], shallow: Boolean = ???): js.Array[js.Any] = js.native
        ...
        def uniq[T, TSort](array: List[T], isSorted: Boolean = false, iterator: /*__.*/ListIterator[T, TSort] = null, context: js.Any = null): js.Array[T] = js.native
        @JSName("uniq")
        def uniqNoBoolean[T, TSort](array: List[T], iterator: /*__.*/ListIterator[T, TSort] = ???, context: js.Any = ???): js.Array[T] = js.native
        @JSName("unique")
        def uniqueNoBoolean[T, TSort](array: List[T], iterator: /*__.*/ListIterator[T, TSort] = ???, context: js.Any = ???): js.Array[T] = js.native
        def unique[T, TSort](array: List[T], isSorted: Boolean = false, iterator: /*__.*/ListIterator[T, TSort] = ???, context: js.Any = ???): js.Array[T] = js.native
        ...
        def `object`[TResult <: AnyRef](list: List[js.Any], values: js.Any = ???): TResult = js.native
        ...
        def sortedIndex[T, TSort](list: List[T], value: T, iterator: js.Function1[T, TSort] = ???, context: js.Any = ???): Double = js.native
        ...
        def mapObject[T, U](`object`: Dictionary[T], iteratee: js.Function3[T, String, Dictionary[T], U], context: js.Any = ???): Dictionary[U] = js.native
        @JSName("mapObject")
        def mapObjectGeneric[T](`object`: js.Any, iteratee: js.Function3[js.Any, String, js.Any, T], context: js.Any = ???): Dictionary[T] = js.native
        @JSName("mapObject")
        def mapObjectString(`object`: js.Any, iteratee: String, context: js.Any = ???): Dictionary[js.Any] = js.native
    ...
    trait Underscore[T] extends js.Object {
        ...
        def groupBy(iterator: /*__.*/ListIterator[T, js.Any] = ???, context: js.Any = ???): Dictionary[List[T]] = js.native
        @JSName("groupBy")
        def groupByString(iterator: String, context: js.Any = ???): Dictionary[js.Array[T]] = js.native
        def indexBy(iterator: /*__.*/ListIterator[T, js.Any], context: js.Any = ???): Dictionary[T] = js.native
        def countBy(iterator: /*__.*/ListIterator[T, js.Any] = ???, context: js.Any = ???): Dictionary[Double] = js.native
